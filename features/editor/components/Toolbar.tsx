...
export const Toolbar = ({
    ...
    if (editor?.selectedObjects.length === 0) {
        ...
        items-center overflow-auto z-[49] p-2 gap-x-2"></div>)
    }
    return (
        <div className="shrink-0 h-[56px] border-b bg-white w-full flex
        items-center overflow-auto z-[49] p-2 gap-x-2">
                ...
                <Hint label="Color" side="bottom" sideOffset={5}>
                    ...
                    >
                        <div className="rounded-sm size-4 border"
                            style={{ backgroundColor: typeof properties.fillColor === "string" ? properties.fillColor: "black"}}>
                ...
                {!isText && (
                    <div className="flex items-center h-full justify-center">
                        <Hint label="Stroke color" side="bottom" sideOffset={5}>
                            ...
                            >
                                <div className="rounded-sm size-4 border-2 bg-white"
                                style={{ borderColor: typeof properties.strokeColor === "string" ? properties.strokeColor : "black" }}>
